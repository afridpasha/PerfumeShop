    ...
    <div className="about-container">
      ...
      <section className="about-team">
        <div className="about-section-content">
          <h2>Our Team</h2>
          <p>
            Behind Perfume Shop is a dedicated team of perfumers, designers, and fragrance experts who share a passion 
            for creating extraordinary scents. Our diverse team brings together expertise from various backgrounds, 
            ensuring that our collection offers something for everyone.
          </p>
          <div className="team-members">
            <div className="team-member">
              <div className="member-photo" style={{ backgroundColor: '#f0e6f5' }}>JS</div>
              <h3>John Smith</h3>
              <p>Founder & Head Perfumer</p>
            </div>
            <div className="team-member">
              <div className="member-photo" style={{ backgroundColor: '#e6f0f5' }}>EA</div>
              <h3>Emily Anderson</h3>
              <p>Creative Director</p>
            </div>
            <div className="team-member">
              <div className="member-photo" style={{ backgroundColor: '#f5f0e6' }}>MR</div>
